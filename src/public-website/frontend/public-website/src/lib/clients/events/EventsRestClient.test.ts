...
describe('EventsRestClient', () => {
  ...
  beforeEach(() => {
    ...
    // Force the mock to be set up again to prevent vitest config overrides
  ...
  describe('Shared Cache Behavior', () => {
    it('should use shared RestClientCache for caching operations', async () => {
      ...
      // Mock the response for potential API call (first request)
      mockFetch.mockResolvedValue(createMockResponse(mockEventsResponse));
