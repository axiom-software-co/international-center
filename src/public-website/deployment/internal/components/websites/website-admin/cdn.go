...
func NewCDNComponent(ctx *pulumi.Context, name string, args *CDNArgs, opts ...pulumi.ResourceOption) (*CDNComponent, error) {
	...
	if canRegister(ctx) {
		err := ctx.RegisterComponentResource("international-center:admin:CDN", name, component, opts...)
		if err != nil {
			return nil, err
		}
	}
	...
	case "staging":
		cdnEndpoint = pulumi.String("https://admin-portal-staging.azureedge.net").ToStringOutput()
		cacheConfiguration = pulumi.Map{
			"enabled":              pulumi.Bool(true),
			"static_content_ttl":   pulumi.Int(1800),    // 30 minutes (shorter for admin portal)
			"dynamic_content_ttl":  pulumi.Int(60),      // 1 minute (shorter for admin portal)
			...
			"auth_required":        pulumi.Bool(true),
		}.ToMapOutput()
	...
	case "production":
		cdnEndpoint = pulumi.String("https://admin-portal-production.azureedge.net").ToStringOutput()
		cacheConfiguration = pulumi.Map{
			"enabled":              pulumi.Bool(true),
			"static_content_ttl":   pulumi.Int(3600),    // 1 hour (shorter than public website)
			"dynamic_content_ttl":  pulumi.Int(300),     // 5 minutes (shorter for admin portal)
			"compression":          pulumi.Bool(true),
			"compression_types":    pulumi.StringArray{
				pulumi.String("text/html"),
				pulumi.String("text/css"),
			...
			"auth_required":        pulumi.Bool(true),
			"geo_filtering":        pulumi.Bool(true),
		}.ToMapOutput()
		compressionEnabled = pulumi.Bool(true).ToBoolOutput()
		edgeLocations = pulumi.Array{
