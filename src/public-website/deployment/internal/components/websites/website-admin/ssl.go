...
func NewSSLComponent(ctx *pulumi.Context, name string, args *SSLArgs, opts ...pulumi.ResourceOption) (*SSLComponent, error) {
	...
	if canRegister(ctx) {
		err := ctx.RegisterComponentResource("international-center:admin:SSL", name, component, opts...)
		if err != nil {
			return nil, err
		}
	}
	...
	case "staging":
		...
		certificateSettings = pulumi.Map{
			...
			"client_certificate_required": pulumi.Bool(false),
		}.ToMapOutput()
		securityHeaders = pulumi.Map{
			...
			"admin_access_control":      pulumi.Bool(true),
		}.ToMapOutput()
	case "production":
		...
		certificateSettings = pulumi.Map{
			...
			"client_certificate_required": pulumi.Bool(true),
			"mutual_tls_enabled": pulumi.Bool(true),
		}.ToMapOutput()
		securityHeaders = pulumi.Map{
			"strict_transport_security": pulumi.Bool(true),
			"content_security_policy":   pulumi.Bool(true),
			...
			"admin_access_control":      pulumi.Bool(true),
			"audit_logging":            pulumi.Bool(true),
			"geo_blocking":             pulumi.Bool(true),
		}.ToMapOutput()
	default:
