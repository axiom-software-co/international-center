...
func DeployStack(ctx *pulumi.Context) error {
	log.Printf("Deploying Staging Stack for International Center")
	...
	// Export primary outputs for Staging environment
	ctx.Export("environment", pulumi.String("staging"))
	...
	log.Printf("Staging Stack deployment completed successfully")
	return nil
}